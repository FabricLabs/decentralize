...
function DECENTRALIZE (config) {
  ...
  Show = self.app.define('Show', {
    ...
    names: { get: 'item' },
    source: self.source.proto + '://' + self.source.authority + '/recordings',
    icon: 'sound'
  });
...
DECENTRALIZE.prototype.start = function (done) {
  ...
  console.log('starting:', self.source.base);
  ...
  procure( self.source.base + '/shows/decentralize' , function(err, show) {
    ...
    console.log('came back:', err, show);
